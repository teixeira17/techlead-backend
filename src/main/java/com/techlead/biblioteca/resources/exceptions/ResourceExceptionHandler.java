package com.techlead.biblioteca.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> forbiden(ForbidenException e, HttpServletRequest request) {
	...
	public ResponseEntity<StandardError> forbiden(DuplicateEntityException e, HttpServletRequest request) {
		HttpStatus status = HttpStatus.BAD_REQUEST;
		StandardError err = new StandardError();
		err.setTimestamp(Instant.now());
		err.setStatus(status.value());
